...
/* harmony import */ var _node_entry_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1553);
...
/* harmony import */ var util__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9023);
/* harmony import */ var stream__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(2203);
/* harmony import */ var os__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(857);
/* harmony import */ var events__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(4434);
/* harmony import */ var node_os__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(8161);
/* harmony import */ var _parseAst_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(833);
/* harmony import */ var _native_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(2969);
/* harmony import */ var node_perf_hooks__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(643);
/* harmony import */ var node_fs_promises__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(1455);
/*
  @license
	Rollup.js v4.63.1
...
function requireConstants$3 () {
	...
	const path = path__WEBPACK_IMPORTED_MODULE_3__;
	const WIN_SLASH = '\\\\/';
...
function requireReaddirp () {
	...
	const sysPath = path__WEBPACK_IMPORTED_MODULE_3__;
...
function requireGlobParent () {
	...
	var pathPosixDirname = path__WEBPACK_IMPORTED_MODULE_3__.posix.dirname;
	var isWin32 = os__WEBPACK_IMPORTED_MODULE_7__.platform() === 'win32';
...
function requireConstants () {
	...
	(function (exports) {
		...
		const {sep} = path__WEBPACK_IMPORTED_MODULE_3__;
		const {platform} = process;
		const os = os__WEBPACK_IMPORTED_MODULE_7__;
...
const require$$3 = /*@__PURE__*/(0,_node_entry_js__WEBPACK_IMPORTED_MODULE_0__/* .getAugmentedNamespace */ .qT)(_node_entry_js__WEBPACK_IMPORTED_MODULE_0__/* .fseventsImporter */ .$$);
...
function requireChokidar () {
	...
	const { EventEmitter } = events__WEBPACK_IMPORTED_MODULE_8__;
	const fs = fs__WEBPACK_IMPORTED_MODULE_4__;
	const sysPath = path__WEBPACK_IMPORTED_MODULE_3__;
	const { promisify } = util__WEBPACK_IMPORTED_MODULE_5__;
...
const chokidar = /*@__PURE__*/(0,_node_entry_js__WEBPACK_IMPORTED_MODULE_0__/* .getDefaultExportFromCjs */ .gB)(chokidarExports);
...
class FileWatcher {
    ...
    createWatcher(transformWatcherId) {
        ...
        const isLinux = (0,node_os__WEBPACK_IMPORTED_MODULE_9__.platform)() === 'linux';
        const isFreeBSD = (0,node_os__WEBPACK_IMPORTED_MODULE_9__.platform)() === 'freebsd';
...
class Watcher {
    constructor(optionsList, emitter) {
        ...
        node_process__WEBPACK_IMPORTED_MODULE_2__.nextTick(() => this.run());
    }
    async close() {
        if (this.closed)
            return;
...
class Task {
    constructor(watcher, options) {
        ...
        this.outputFiles = this.outputs.map(output => {
            if (output.file || output.dir)
                return node_path__WEBPACK_IMPORTED_MODULE_1__.resolve(output.file || output.dir);
            return undefined;
        });
        this.watchOptions = this.options.watch || {};
        this.filter = (0,_node_entry_js__WEBPACK_IMPORTED_MODULE_0__/* .createFilter */ .HI)(this.watchOptions.include, this.watchOptions.exclude);
    ...
    async run() {
        ...
        let result = null;
        try {
            result = await (0,_node_entry_js__WEBPACK_IMPORTED_MODULE_0__/* .rollupInternal */ .Yg)(options, this.watcher.emitter);
            if (this.closed) {
                return;
            }
