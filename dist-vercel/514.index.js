...
/* harmony export */   rollup: () => (/* reexport safe */ _shared_node_entry_js__WEBPACK_IMPORTED_MODULE_0__.z),
/* harmony export */   watch: () => (/* reexport safe */ _shared_node_entry_js__WEBPACK_IMPORTED_MODULE_0__.wB)
/* harmony export */ });
/* harmony import */ var _shared_node_entry_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1553);
/* harmony import */ var _shared_parseAst_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(833);
/* harmony import */ var _native_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2969);
...
/* harmony import */ var node_perf_hooks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(643);
/* harmony import */ var node_fs_promises__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(1455);
/*
  @license
	Rollup.js v4.63.1
...
var node_fs_promises__WEBPACK_IMPORTED_MODULE_6___namespace_cache;
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $$: () => (/* binding */ fseventsImporter),
/* harmony export */   HI: () => (/* binding */ createFilter$1),
/* harmony export */   Yg: () => (/* binding */ rollupInternal),
/* harmony export */   gB: () => (/* binding */ getDefaultExportFromCjs),
/* harmony export */   qT: () => (/* binding */ getAugmentedNamespace),
/* harmony export */   wB: () => (/* binding */ watch),
/* harmony export */   z: () => (/* binding */ rollup)
/* harmony export */ });
/* unused harmony exports VERSION, defineConfig */
/* harmony import */ var _parseAst_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(833);
/* harmony import */ var node_path__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6760);
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6928);
/* harmony import */ var _native_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2969);
/* harmony import */ var node_process__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1708);
/* harmony import */ var node_perf_hooks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(643);
/* harmony import */ var node_fs_promises__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1455);
/*
  @license
	Rollup.js v4.63.1
	Fri, 28 Aug 2026 05:58:50 GMT - commit 78bfef0cb94479566f81012fafa372c84b90bd34
...
const UNKNOWN_INCLUDED_PATH = Object.freeze({ [UnknownKey]: _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0 });
...
class Variable extends ExpressionEntity {
    ...
    addUsedPlace(usedPlace) {
        const isFunctionCall = usedPlace.parent.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .CallExpression */ .DG &&
            usedPlace.parent.callee === usedPlace;
        if (!isFunctionCall && usedPlace.parent.type !== _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ExportDefaultDeclaration */ .M3) {
...
class ExternalModule {
    constructor(options, id, moduleSideEffects, meta, renormalizeRenderPath, attributes) {
        ...
        this.info = {
            ...
            attributes,
            code: null,
            dynamicallyImportedIdResolutions: _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .Ml,
            dynamicallyImportedIds: _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .Ml,
            ...
            id,
            implicitlyLoadedAfterOneOf: _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .Ml,
            implicitlyLoadedBefore: _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .Ml,
            importedIdResolutions: _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .Ml,
            importedIds: _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .Ml,
            get importers() {
    ...
    warnUnusedImports() {
        ...
        this.options.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logUnusedExternalImports */ .Ec)(this.id, unused, importersArray));
    }
}
    ...
    parseNode(esTreeNode) {
        for (const [key, value] of Object.entries(esTreeNode)) {
            ...
            if (key.charCodeAt(0) === 95 /* _ */) {
                if (key === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ANNOTATION_KEY */ .MD) {
                    this.annotations = value;
                }
                else if (key === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .INVALID_ANNOTATION_KEY */ .ED) {
...
function isObjectExpressionNode(node) {
    return node instanceof NodeBase && node.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ObjectExpression */ .wl;
}
function isPropertyNode(node) {
    return node instanceof NodeBase && node.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .Property */ .mA;
}
function isArrowFunctionExpressionNode(node) {
    return node instanceof NodeBase && node.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ArrowFunctionExpression */ .gZ;
}
function isFunctionExpressionNode(node) {
    return node instanceof NodeBase && node.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .FunctionExpression */ .$m;
}
function isCallExpressionNode(node) {
    return node instanceof NodeBase && node.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .CallExpression */ .DG;
}
function isMemberExpressionNode(node) {
    return node instanceof NodeBase && node.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .MemberExpression */ .LN;
}
function isAwaitExpressionNode(node) {
    return node instanceof NodeBase && node.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .AwaitExpression */ .p$;
}
function isIdentifierNode(node) {
    return node instanceof NodeBase && node.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .Identifier */ .gw;
}
function isExpressionStatementNode(node) {
    return node instanceof NodeBase && node.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ExpressionStatement */ .Qr;
}
...
class LocalVariable extends Variable {
    ...
    deoptimizePath(path) {
        ...
        if (path.length === 0) {
            ...
            this.expressionsToBeDeoptimized = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .Ml;
            for (const expression of expressionsToBeDeoptimized) {
                expression.deoptimizeCache();
            }
        ...
        if (!this.includedPathTracker.includePathAndGetIfIncluded(path)) {
            ...
            for (const declaration of this.declarations) {
                ...
                while (!node.included) {
                    ...
                    if (node.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .Program */ .BP)
                        break;
                    node = node.parent;
                }
            }
...
class IdentifierBase extends NodeBase {
    ...
    disallowImportReassignment() {
        return this.scope.context.error((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logIllegalImportReassignment */ .Iv)(this.name, this.scope.context.module.id), this.start);
    }
...
class Identifier extends IdentifierBase {
    ...
    render(code, { snippets: { getPropertyAccess }, useOriginalName }, { renderedParentType, isCalleeOfRenderedParent, isShorthandProperty } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) {
        if (this.variable) {
            ...
            if (name === 'eval' &&
                renderedParentType === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .CallExpression */ .DG &&
...
class Scope {
    ...
    addDeclaration(identifier, context, init, destructuredInitPath, kind) {
        ...
        if (existingVariable) {
            ...
            context.error((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logRedeclarationError */ .gk)(name), identifier.start);
        }
    ...
    addDeclaration(identifier, context, init, destructuredInitPath, kind) {
        if (kind === 'var') {
            ...
            if (existingVariable) {
                ...
                return context.error((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logRedeclarationError */ .gk)(name), identifier.start);
            }
...
function isStaticBlock(statement) {
    return statement.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .StaticBlock */ .UD;
}
...
const NO_INTERACTIONS = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .Ml;
...
class ParameterVariable extends LocalVariable {
    ...
    markReassigned() {
        ...
        this.expressionsDependingOnKnownValue = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .Ml;
    }
    deoptimizeCache() {
        this.markReassigned();
    }
        ...
        if (kind === 'var') {
            ...
            if (existingVariable) {
                ...
                if (existingKind === 'parameter' &&
                    ...
                    existingVariable.declarations[0].parent.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .CatchClause */ .Db) {
...
class ParameterScope extends ChildScope {
    ...
    addParameterDeclaration(identifier, argumentPath) {
        ...
        if (existingParameter) {
            return this.context.error((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logDuplicateArgumentNameError */ .o3)(name), start);
        }
...
class ExpressionStatement extends NodeBase {
    initialise() {
        ...
        if (this.directive &&
            ...
            this.parent.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .Program */ .BP) {
            this.scope.context.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, 
            // This is necessary, because either way (deleting or not) can lead to errors.
            (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logModuleLevelDirective */ .gY)(this.directive, this.scope.context.module.id), this.start);
        }
    }
    removeAnnotations(code) {
    ...
    shouldBeIncluded(context) {
        if (this.directive && this.directive !== 'use strict')
            return this.parent.type !== _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .Program */ .BP;
...
class BlockStatement extends NodeBase {
    ...
    addImplicitReturnExpressionToScope() {
        ...
        if (!lastStatement || lastStatement.type !== _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ReturnStatement */ .ch) {
...
class FunctionBase extends NodeBase {
    ...
    onlyFunctionCallUsed() {
        let variable = null;
        if (this.parent.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .VariableDeclarator */ .ax) {
            variable = this.parent.id.variable ?? null;
        }
        if (this.parent.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ExportDefaultDeclaration */ .M3) {
    ...
    render(code, options, nodeRenderOptions) {
        ...
        if (this.declaration instanceof FunctionDeclaration) {
            ...
            this.declaration.render(code, options, {
                renderedSurroundingElement: _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ExpressionStatement */ .Qr
            });
            if (code.original[this.end - 1] !== ';') {
                code.appendLeft(this.end, ';');
            }
...
class MemberExpression extends NodeBase {
    ...
    render(code, options, { renderedParentType, isCalleeOfRenderedParent, renderedSurroundingElement } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) {
        if (this.variable || this.isUndefined) {
    ...
    disallowNamespaceReassignment() {
        if (this.object instanceof Identifier) {
            ...
            if (variable.isNamespace) {
                ...
                this.scope.context.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logIllegalImportReassignment */ .Iv)(this.object.name, this.scope.context.module.id), this.start);
            }
        }
    }
...
function resolveNamespaceVariables(baseVariable, path, astContext) {
    ...
    if (!variable) {
        if (path.length === 1) {
            ...
            astContext.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logMissingExport */ .Lj)(exportName, astContext.module.id, fileName, !!options?.missingButExportExists), path[0].pos);
            return 'undefined';
        }
        return null;
    }
...
class MetaProperty extends NodeBase {
    ...
    render(code, renderOptions) {
        ...
        if (referenceId) {
            ...
            const relativePath = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .normalize */ .S8)((0,node_path__WEBPACK_IMPORTED_MODULE_1__.relative)((0,node_path__WEBPACK_IMPORTED_MODULE_1__.dirname)(chunkId), fileName));
...
class ExternalChunk {
    ...
    getFileName() {
        ...
        return (this.fileName =
            (typeof paths === 'function' ? paths(this.id) : paths[this.id]) ||
                (this.renormalizeRenderPath ? (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .normalize */ .S8)((0,node_path__WEBPACK_IMPORTED_MODULE_1__.relative)(this.inputBase, this.id)) : this.id));
    }
    ...
    getImportPath(importer) {
        return escapeId(this.renormalizeRenderPath
            ? (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .getImportPath */ .RY)(importer, this.getFileName(), this.options.format === 'amd', false)
            : this.getFileName());
    }
}
...
function throwOnPhase(outputFormat, chunkId, dependencies) {
    ...
    if (sourcePhaseDependency) {
        (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logSourcePhaseFormatUnsupported */ .nM)(outputFormat, chunkId, sourcePhaseDependency.importPath));
    }
}
...
function warnOnBuiltins(log, dependencies) {
    ...
    if (externalBuiltins.length === 0)
        return;
    log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logMissingNodeBuiltins */ .zK)(externalBuiltins));
}
...
function setupNamespace(name, root, globals, { _, getPropertyAccess, s }, compact, log) {
    ...
    if (log && isReserved) {
        log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logReservedNamespace */ .oT)(parts[0]));
    }
    parts[0] =
...
function iife(magicString, { accessedGlobals, dependencies, exports, hasDefaultExport, hasExports, id, indent: t, intro, namedExportsMode, log, outro, snippets }, { compact, esModule, extend, freeze, externalLiveBindings, reexportProtoFromExternal, globals, interop, name, generatedCode: { symbols }, strict }) {
    ...
    if (name && useVariableAssignment && !isLegal(name)) {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logIllegalIdentifierAsName */ .rB)(name));
    }
    warnOnBuiltins(log, dependencies);
    ...
    if (hasExports && !name) {
        log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logMissingNameOptionForIifeExport */ .z7)());
    }
    if (hasExports && (namedExportsMode || exports[0]?.local === 'exports.default')) {
        if (extend) {
...
function umd(magicString, { accessedGlobals, dependencies, exports, hasDefaultExport, hasExports, id, indent: t, intro, namedExportsMode, log, outro, snippets }, { amd, compact, esModule, extend, externalLiveBindings, freeze, interop, name, generatedCode: { symbols }, globals, noConflict, reexportProtoFromExternal, strict }) {
    ...
    if (hasExports && !name) {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logMissingNameOptionForUmdExport */ .We)());
    }
...
const normalizePathRegExp = new RegExp(`\\${path__WEBPACK_IMPORTED_MODULE_2__.win32.sep}`, 'g');
const normalizePath = function normalizePath(filename) {
    return filename.replace(normalizePathRegExp, path__WEBPACK_IMPORTED_MODULE_2__.posix.sep);
};
...
class ArrowFunctionExpression extends FunctionBase {
    ...
    onlyFunctionCallUsed() {
        const isIIFE = this.parent.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .CallExpression */ .DG &&
...
class ObjectPattern extends NodeBase {
    addExportedVariables(variables, exportNamesByVariable) {
        for (const property of this.properties) {
            if (property.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .Property */ .mA) {
    ...
    includeDestructuredIfNecessary(context, destructuredInitPath, init) {
        ...
        const lastPropertyIsRestElement = lastProperty.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .RestElement */ .Xx;
    ...
    initialise() {
        ...
        if (this.left instanceof Identifier) {
            ...
            if (variable?.kind === 'const') {
                ...
                this.scope.context.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logConstVariableReassignError */ .SX)(), this.left.start);
            }
        }
        this.left.setAssignedValue(this.right);
    }
    render(code, options, { preventASI, renderedParentType, renderedSurroundingElement } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) {
            ...
            if (left instanceof Identifier) {
                ...
                if (exportNames) {
                    if (exportNames.length === 1) {
                        ...
                        renderSystemExportSequenceAfterExpression(variable, start, end, parent.type !== _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ExpressionStatement */ .Qr, code, options);
                    }
                    return;
                }
            }
                ...
                if (systemPatternExports.length > 0) {
                    renderSystemExportFunction(systemPatternExports, start, end, renderedSurroundingElement === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ExpressionStatement */ .Qr, code, options);
                    return;
                }
            }
        }
        if (left.included &&
            ...
            (renderedSurroundingElement === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ExpressionStatement */ .Qr ||
                renderedSurroundingElement === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ArrowFunctionExpression */ .gZ)) {
...
class AssignmentPattern extends NodeBase {
    ...
    render(code, options, { isShorthandProperty } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) {
...
class BinaryExpression extends NodeBase {
    ...
    render(code, options, { renderedSurroundingElement } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) {
...
class CallExpressionBase extends NodeBase {
    ...
    deoptimizeCache() {
        if (this.returnExpression?.[0] !== UNKNOWN_EXPRESSION) {
            ...
            this.expressionsToBeDeoptimized = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_SET */ .XR;
            this.deoptimizableDependentExpressions = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .Ml;
...
class CallExpression extends CallExpressionBase {
    ...
    render(code, options, { renderedSurroundingElement } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) {
        ...
        if (this.callee instanceof Identifier && !this.hasCheckedForWarnings) {
            ...
            if (variable.isNamespace) {
                this.scope.context.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logCannotCallNamespace */ .BK)(this.callee.name), this.start);
            }
            if (this.callee.name === 'eval') {
                this.scope.context.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logEval */ .Z5)(this.scope.context.module.id), this.start);
            }
        }
    }
    applyDeoptimizations() {
...
class ClassExpression extends ClassNode {
    render(code, options, { renderedSurroundingElement } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) {
        super.render(code, options);
        if (renderedSurroundingElement === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ExpressionStatement */ .Qr) {
...
class ConditionalExpression extends NodeBase {
    ...
    render(code, options, { isCalleeOfRenderedParent, preventASI, renderedParentType, renderedSurroundingElement } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) {
...
class IfStatement extends NodeBase {
    ...
    renderHoistedDeclarations(hoistedDeclarations, code, getPropertyAccess) {
        ...
        if (hoistedVariables) {
            ...
            const needsBraces = parentType !== _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .Program */ .BP && parentType !== _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BlockStatement */ .Zf;
...
class JSXAttribute extends NodeBase {
    render(code, options, { jsxMode } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) {
        super.render(code, options);
...
class PanicError extends NodeBase {
    initialise() {
        ...
        const parseError = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .getRollupError */ .f9)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logParseError */ .kG)(this.message));
        const moduleParseError = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logModuleParseError */ .Uo)(parseError, id);
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)(moduleParseError);
    }
}
...
class ParseError extends NodeBase {
    initialise() {
        ...
        // This simulates the current nested error structure. We could also just
        // replace it with a flat error.
        const parseError = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .getRollupError */ .f9)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logParseError */ .kG)(this.message, pos));
        const moduleParseError = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logModuleParseError */ .Uo)(parseError, id);
        ...
        for (const node of this.body) {
            if (node.hasEffects(context)) {
                if (this.scope.context.options.experimentalLogSideEffects && !this.hasLoggedEffect) {
                    ...
                    log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_INFO */ .w0, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFirstSideEffect */ .BT)(code, module.id, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .locate */ .x5)(code, node.start, { offsetLine: 1 })), node.start);
                }
        ...
        if (this.invalidAnnotations)
            for (const { start, end, type } of this.invalidAnnotations) {
                ...
                if (type === 'pure' || type === 'noSideEffects') {
                    this.scope.context.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidAnnotation */ .j$)(this.scope.context.code.slice(start, end), this.scope.context.module.id, type), start);
                }
            }
    }
    render(code, options) {
...
class SequenceExpression extends NodeBase {
    ...
    render(code, options, { renderedParentType, isCalleeOfRenderedParent, preventASI } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) {
        let includedNodes = 0;
        let lastSeparatorPos = null;
...
class TaggedTemplateExpression extends CallExpressionBase {
    ...
    render(code, options) {
        ...
        if (!this.hasCheckedForWarnings && this.tag.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .Identifier */ .gw) {
            this.hasCheckedForWarnings = true;
            const name = this.tag.name;
            const variable = this.scope.findVariable(name);
            if (variable.isNamespace) {
                this.scope.context.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logCannotCallNamespace */ .BK)(name), this.start);
            }
        }
    }
    applyDeoptimizations() {
...
class ModuleScope extends ChildScope {
    ...
    addDeclaration(identifier, context, init, destructuredInitPath, kind) {
        if (this.importDescriptions.has(identifier.name)) {
            context.error((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logRedeclarationError */ .gk)(identifier.name), identifier.start);
        }
        return super.addDeclaration(identifier, context, init, destructuredInitPath, kind);
    }
...
class ThisExpression extends NodeBase {
    ...
    initialise() {
        ...
        if (this.alias === 'undefined') {
            this.scope.context.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logThisIsUndefined */ .R1)(), this.start);
        }
    }
    render(code) {
        if (this.alias !== null) {
            ...
            if (exportNames) {
                if (this.prefix) {
                    if (exportNames.length === 1) {
                        ...
                        renderSystemExportSequenceAfterExpression(variable, this.start, this.end, this.parent.type !== _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ExpressionStatement */ .Qr, code, options);
                    }
                }
                else {
                    const operator = this.operator[0];
                    renderSystemExportSequenceBeforeExpression(variable, this.start, this.end, this.parent.type !== _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ExpressionStatement */ .Qr, code, options, `${_}${operator}${_}1`);
                }
            }
        }
    }
...
class VariableDeclaration extends NodeBase {
    ...
    include(context, includeChildrenRecursively, { asSingleStatement } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) {
        this.included = true;
        for (const declarator of this.declarations) {
    ...
    render(code, options, nodeRenderOptions = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) {
    ...
    areAllDeclarationsIncludedAndNotExported(exportNamesByVariable) {
        ...
        for (const declarator of this.declarations) {
            if (!declarator.id.included)
                return false;
            if (declarator.id.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .Identifier */ .gw) {
...
class VariableDeclarator extends NodeBase {
    ...
    render(code, options) {
        ...
        if (init) {
            ...
            init.render(code, options, renderId ? _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4 : { renderedSurroundingElement: _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .ExpressionStatement */ .Qr });
        }
...
function convertProgram(buffer, parent, parentScope) {
    return convertNode(parent, parentScope, 0, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .getAstBuffer */ .pB)(buffer));
}
...
const bufferParsers = [
    ...
    function arrowFunctionExpression(node, position, buffer) {
        ...
        const annotations = (node.annotations = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .convertAnnotations */ .Kx)(buffer[position + 1], buffer));
    ...
    function assignmentExpression(node, position, buffer) {
        const { scope } = node;
        node.operator = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .FIXED_STRINGS */ .aC[buffer[position]];
    ...
    function callExpression(node, position, buffer) {
        ...
        node.annotations = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .convertAnnotations */ .Kx)(buffer[position + 1], buffer);
    ...
    function importDeclaration(node, position, buffer) {
        ...
        node.phase = phaseIndex === 0 ? undefined : _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .FIXED_STRINGS */ .aC[phaseIndex];
    },
    ...
    function importExpression(node, position, buffer) {
        ...
        node.sourceAstNode = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .convertNode */ .IN)(buffer[position], buffer);
    ...
    function methodDefinition(node, position, buffer) {
        ...
        node.kind = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .FIXED_STRINGS */ .aC[buffer[position + 4]];
    },
    function newExpression(node, position, buffer) {
        const { scope } = node;
        node.annotations = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .convertAnnotations */ .Kx)(buffer[position], buffer);
    ...
    function program(node, position, buffer) {
        const { scope } = node;
        node.body = convertNodeList(node, scope, buffer[position], buffer);
        node.invalidAnnotations = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .convertAnnotations */ .Kx)(buffer[position + 1], buffer);
    },
    function property(node, position, buffer) {
        ...
        node.kind = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .FIXED_STRINGS */ .aC[buffer[position + 3]];
    ...
    function updateExpression(node, position, buffer) {
        ...
        node.operator = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .FIXED_STRINGS */ .aC[buffer[position + 1]];
        node.argument = convertNode(node, scope, buffer[position + 2], buffer);
    },
    function variableDeclaration(node, position, buffer) {
        const { scope } = node;
        node.kind = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .FIXED_STRINGS */ .aC[buffer[position]];
...
function convertNodeList(parent, parentScope, position, buffer) {
    if (position === 0)
        return _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .Ml;
...
function getAttributesFromImportExpression(node) {
    ...
    if (!(options instanceof ObjectExpression)) {
        if (options) {
            context.module.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logImportAttributeIsInvalid */ .T_)(context.module.id), start);
        }
        return _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0;
    }
    ...
    if (!(assertProperty instanceof ObjectExpression)) {
        context.module.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logImportOptionsAreInvalid */ .Bj)(context.module.id), start);
        return _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0;
    }
    const assertFields = assertProperty.properties
        ...
        context.module.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logImportAttributeIsInvalid */ .T_)(context.module.id), property.start);
        return null;
    })
...
function getAttributesFromImportExportDeclaration(attributes) {
    return attributes?.length
        ...
        : _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0;
}
...
function getVariableForExportNameRecursive(target, name, importerForSideEffects, isExportAllSearch, searchedNamesAndModules = new Map(), importChain, sideEffectModules, exportOrReexportModules) {
    ...
    if (searchedModules) {
        if (searchedModules.has(target)) {
            return isExportAllSearch ? [null] : (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logCircularReexport */ .bi)(name, target.id));
        }
...
class Module {
    ...
    error(properties, pos) {
        ...
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)(properties);
    }
        ...
        for (const name of this.exportDescriptions.keys()) {
            ...
            if (name !== this.info.syntheticNamedExports) {
                ...
                if (exportedVariable) {
                    ...
                    return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logMissingEntryExport */ .xV)(name, this.id));
                }
            }
        }
    ...
    getSyntheticNamespace() {
        ...
        if (!this.syntheticNamespace) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logSyntheticNamedExportsNeedNamespaceExport */ .$h)(this.id, this.info.syntheticNamedExports));
        }
        return this.syntheticNamespace;
    }
    getVariableForExportName(name, { importerForSideEffects, importChain = [], isExportAllSearch, onlyExplicit, searchedNamesAndModules, sideEffectModules, exportOrReexportModules } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0) {
        if (name[0] === '*') {
            if (name.length === 1) {
                // export * from './other'
        ...
        if (reexportDeclaration) {
            ...
            if (!variable) {
                return this.error((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logMissingExport */ .Lj)(reexportDeclaration.localName, this.id, reexportDeclaration.module.id, !!options?.missingButExportExists), reexportDeclaration.start);
            }
    ...
    render(options) {
        ...
        if (usesTopLevelAwait && options.format !== 'es' && options.format !== 'system') {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidFormatForTopLevelAwait */ .B2)(this.id, options.format));
        }
    ...
    async setSource({ ast, code, customTransformCache, originalCode, originalSourcemap, resolvedIds, sourcemapChain, transformDependencies, transformFiles, safeVariableNames, ...moduleOptions }) {
        ...
        if (ast) {
            ...
            const astBuffer = await (0,_native_js__WEBPACK_IMPORTED_MODULE_3__/* .parseAsync */ .EJ)(code, false, this.options.jsx !== false);
            timeStart('generate ast', 3);
    ...
    traceVariable(name, { importerForSideEffects, isExportAllSearch, searchedNamesAndModules, sideEffectModules, exportOrReexportModules } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0) {
        ...
        if (importDescription) {
            ...
            if (!declaration) {
                return this.error((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logMissingExport */ .Lj)(importDescription.name, this.id, otherModule.id, !!options?.missingButExportExists), importDescription.start);
            }
            return declaration;
        }
        return null;
    ...
    addDynamicImport(node) {
        ...
        if (argument.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .TemplateLiteral */ .k_) {
            if (argument.quasis.length === 1 &&
                typeof argument.quasis[0].value.cooked === 'string') {
                argument = argument.quasis[0].value.cooked;
            }
        }
        else if (argument.type === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .Literal */ .uS &&
    ...
    assertUniqueExportName(name, nodeStart) {
        if (this.exportDescriptions.has(name) || this.reexportDescriptions.has(name)) {
            this.error((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logDuplicateExportError */ .Ew)(name), nodeStart);
        }
    }
    addExport(node) {
    ...
    addImport(node) {
        ...
        for (const specifier of node.specifiers) {
            ...
            if (this.scope.variables.has(localName) || this.importDescriptions.has(localName)) {
                this.error((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logRedeclarationError */ .gk)(localName), specifier.local.start);
            }
    ...
    addImportSource(importSource) {
        if (importSource && !this.sourcesWithAttributes.has(importSource)) {
            this.sourcesWithAttributes.set(importSource, _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0);
        }
    }
    addImportMeta(node) {
    ...
    addLocationToLogProps(properties, pos) {
        ...
        const location = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .locate */ .x5)(code, pos, { offsetLine: 1 });
        if (location) {
            ...
            try {
                ...
                this.options.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidSourcemapForError */ .Od)(error_, this.id, column, line, pos));
            }
            (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .augmentCodeLocation */ .n)(properties, { column, line }, code, this.id);
        }
    }
    ...
    addSource(source, declaration) {
        ...
        if (existingAttributes) {
            if (doAttributesDiffer(existingAttributes, parsedAttributes)) {
                this.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInconsistentImportAttributes */ .WX)(existingAttributes, parsedAttributes, source, this.id), declaration.start);
            }
        }
        else {
    ...
    getImportedJsxFactoryVariable(baseName, nodeStart, importSource) {
        ...
        if (!variable) {
            return this.error((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logMissingJsxExport */ .U9)(baseName, id, this.id), nodeStart);
        }
        return variable;
    }
    getVariableFromNamespaceReexports(name, importerForSideEffects, searchedNamesAndModules, importChain) {
        ...
        if (foundInternalDeclarations.size > 0) {
            ...
            this.options.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logNamespaceConflict */ .Wp)(name, this.id, foundDeclarationList.map(([, module]) => module.id)));
        ...
        if (foundExternalDeclarations.size > 0) {
            ...
            if (foundDeclarationList.length > 1) {
                this.options.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logAmbiguousExternalNamespaces */ .iM)(name, this.id, usedDeclaration.module.id, foundDeclarationList.map(declaration => declaration.module.id)));
            }
            return [
                usedDeclaration,
    ...
    shimMissingExport(name) {
        this.options.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logShimmedExport */ .CE)(this.id, name));
        this.exportDescriptions.set(name, MISSING_EXPORT_SHIM_DESCRIPTION);
    }
    tryParse() {
        try {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .parseAst */ .u_)(this.info.code, { jsx: this.options.jsx !== false });
        }
        catch (error_) {
            return this.error((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logModuleParseError */ .Uo)(error_, this.id), error_.pos);
        }
    }
}
...
async function createAddons(options, outputPluginDriver, chunk) {
    try {
        ...
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logAddonNotGenerated */ .R3)(error_.message, error_.hook, error_.plugin));
    }
}
...
function getExportMode(chunk, { exports: exportMode, name, format }, facadeModuleId, log) {
    ...
    if (exportMode === 'default') {
        if (exportKeys.length !== 1 || exportKeys[0] !== 'default') {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logIncompatibleExportOptionValue */ .my)('default', exportKeys, facadeModuleId));
        }
    }
    else if (exportMode === 'none' && exportKeys.length > 0) {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logIncompatibleExportOptionValue */ .my)('none', exportKeys, facadeModuleId));
    }
    if (exportMode === 'auto') {
        if (exportKeys.length === 0) {
            ...
            if (format !== 'es' && format !== 'system' && exportKeys.includes('default')) {
                log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logMixedExport */ .IU)(facadeModuleId, name));
            }
            exportMode = 'named';
        }
    }
...
const getHashPlaceholderGenerator = () => {
    ...
    return (optionName, hashSize) => {
        if (hashSize > MAX_HASH_SIZE) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)(`Hashes cannot be longer than ${MAX_HASH_SIZE} characters, received ${hashSize}. Check the "${optionName}" option.`));
        }
        ...
        if (placeholder.length > hashSize) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)(`To generate hashes for this number of chunks (currently ${nextIndex}), you need a minimum hash size of ${placeholder.length}, received ${hashSize}. Check the "${optionName}" option.`));
        }
        return placeholder;
    };
};
...
function renderNamePattern(pattern, patternName, replacements) {
    if ((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isPathFragment */ .A0)(pattern))
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)(`Invalid pattern "${pattern}" for "${patternName}", patterns can be neither absolute nor relative paths. If you want your files to be stored in a subdirectory, write its name without a leading slash like this: subdirectory/pattern.`));
    return pattern.replace(/\[(\w+)(:\d+)?]/g, (_match, type, size) => {
        if (!replacements.hasOwnProperty(type) || (size && type !== 'hash')) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)(`"[${type}${size || ''}]" is not a valid placeholder in the "${patternName}" pattern.`));
        }
        const replacement = replacements[type](size && Number.parseInt(size.slice(1)));
        if ((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isPathFragment */ .A0)(replacement))
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)(`Invalid substitution "${replacement}" for placeholder "[${type}]" in "${patternName}" pattern, can be neither absolute nor relative path.`));
        return replacement;
    });
}
...
function getGlobalName(chunk, globals, hasExports, log) {
    ...
    if (hasExports) {
        log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logMissingGlobalName */ .BH)(chunk.id, chunk.variableName));
...
class Chunk {
    ...
    getImportPath(importer) {
        return escapeId((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .getImportPath */ .RY)(importer, this.getFileName(), this.outputOptions.format === 'amd' && !this.outputOptions.amd.forceJsExtensionForImports, true));
    }
            ...
            do {
                ...
                if (alternativeReexportModule) {
                    ...
                    if (exportingChunk !== exportChunk) {
                        this.inputOptions.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logCyclicCrossChunkReexport */ .gV)(
    ...
    getDynamicImportStringAndAttributes(resolution, fileName, node) {
        ...
        if (keepExternalImportAttributes) {
            ...
            attributes =
                attributesFromImportAttributes === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0
                    ? true
    ...
    getFallbackChunkName() {
        ...
        if (this.fileName) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .getAliasName */ .aD)(this.fileName);
        }
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .getAliasName */ .aD)(this.orderedModules[this.orderedModules.length - 1].id);
    }
    getImportSpecifiers() {
        ...
        for (const variable of this.imports) {
            ...
            if (module instanceof ExternalModule) {
                ...
                if (!isSourcePhase &&
                    ...
                    return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logUnexpectedNamedImport */ .E2)(module.id, imported, false));
                }
            }
            else {
    ...
    getPreserveModulesChunkNameFromModule(module) {
        ...
        const sanitizedId = sanitizeFileName((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .normalize */ .S8)(module.id.split(QUERY_HASH_REGEX, 1)[0]));
        ...
        const idWithoutExtension = NON_ASSET_EXTENSIONS.has(extensionName)
            ...
            : sanitizedId;
        if ((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isAbsolute */ .oP)(idWithoutExtension)) {
            if (preserveModulesRoot && (0,node_path__WEBPACK_IMPORTED_MODULE_1__.resolve)(idWithoutExtension).startsWith(preserveModulesRoot)) {
                ...
                if (sanitizedBase === '/' && idWithoutExtension[0] !== '/') {
                    return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .relative */ .V8)(sanitizedBase, idWithoutExtension.replace(/^[a-zA-Z]:[/\\]/, '/'));
                }
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .relative */ .V8)(sanitizedBase, idWithoutExtension);
            }
        }
        else {
        ...
        for (let exportName of this.getExportNames()) {
            ...
            if (exportName[0] === '*') {
                ...
                if (interop(id) === 'defaultOnly') {
                    this.inputOptions.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logUnexpectedNamespaceReexport */ .qf)(id));
                }
                ...
                if (module instanceof Module) {
                    ...
                    if (imported !== 'default' && imported !== '*' && interop(module.id) === 'defaultOnly') {
                        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logUnexpectedNamedImport */ .E2)(module.id, imported, true));
                    }
                    needsLiveBinding =
    ...
    renderModules(fileName) {
        ...
        if (isEmpty && this.getExportNames().length === 0 && dependencies.size === 0) {
            onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logEmptyChunk */ .dN)(this.getChunkName()));
        }
...
function getChunkNameFromModule(module) {
    return getPredefinedChunkNameFromModule(module) ?? (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .getAliasName */ .aD)(module.id);
}
...
function getOptimizedChunks(chunks, minChunkSize, sideEffectAtoms, sizeByAtom, log) {
    ...
    if (minChunkSize > 1) {
        log('info', (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logOptimizeChunkStatus */ .lq)(chunks.length, chunkPartition.small.size, 'Initially'));
    }
    mergeChunks(chunkPartition, minChunkSize, sideEffectAtoms, sizeByAtom);
    if (minChunkSize > 1) {
        log('info', (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logOptimizeChunkStatus */ .lq)(chunkPartition.small.size + chunkPartition.big.size, chunkPartition.small.size, 'After merging chunks'));
    }
    timeEnd('optimize chunks', 3);
            ...
            for (const segment of line) {
                ...
                if (traced) {
                    ...
                    if (sourceIndex === undefined) {
                        ...
                        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logConflictingSourcemapSources */ .GO)(filename));
                    }
...
function getLinkMap(log) {
    return function linkMap(source, map) {
        ...
        log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logSourcemapBroken */ .Zr)(map.plugin));
        return new Link({
            mappings: [],
            names: []
        }, [source]);
...
let textEncoder;
const getHash64 = input => (0,_native_js__WEBPACK_IMPORTED_MODULE_3__/* .xxhashBase64Url */ .Xo)(ensureBuffer(input));
const getHash36 = input => (0,_native_js__WEBPACK_IMPORTED_MODULE_3__/* .xxhashBase36 */ .Lz)(ensureBuffer(input));
const getHash16 = input => (0,_native_js__WEBPACK_IMPORTED_MODULE_3__/* .xxhashBase16 */ .df)(ensureBuffer(input));
const hasherByType = {
    base36: getHash36,
    base64: getHash64,
    hex: getHash16
    ...
    if (sourcemap) {
        ...
        for (let sourcesIndex = 0; sourcesIndex < map.sources.length; ++sourcesIndex) {
            ...
            if (typeof ignoreList !== 'boolean') {
                (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)('sourcemapIgnoreList function must return a boolean.'));
            }
            if (ignoreList) {
            ...
            if (sourcemapPathTransform) {
                ...
                if (typeof sourcePath !== 'string') {
                    (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)(`sourcemapPathTransform function must return a string.`));
                }
            }
            map.sources[sourcesIndex] = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .normalize */ .S8)(sourcePath);
        }
    ...
    finaliseAssets(bundle) {
        if (this.outputOptions.validate) {
            for (const file of Object.values(bundle)) {
                if ('code' in file) {
                    try {
                        (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .parseAst */ .u_)(file.code, { jsx: this.inputOptions.jsx !== false });
                    }
                    catch (error_) {
                        this.inputOptions.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logChunkInvalid */ .rn)(file, error_));
                    }
                }
            }
        }
        ...
        const handleDependency = (chunk, parent) => {
            if (parents.has(chunk)) {
                if (!visited.has(chunk)) {
                    ...
                    path.push(path[0]);
                    path.reverse();
                    this.inputOptions.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logCircularChunk */ .Vg)(path, isManualChunkConflict));
                }
                return;
            }
...
function validateOptionsForMultiChunkOutput(outputOptions, log) {
    if (outputOptions.format === 'umd' || outputOptions.format === 'iife')
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.format', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_FORMAT */ .Q$, 'UMD and IIFE output formats are not supported for code-splitting builds', outputOptions.format));
    if (typeof outputOptions.file === 'string')
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.file', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_DIR */ .CN, 'when building multiple chunks, the "output.dir" option must be used, not "output.file". To inline dynamic imports, set the "inlineDynamicImports" option'));
    if (outputOptions.sourcemapFile)
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.sourcemapFile', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_SOURCEMAPFILE */ .ih, '"output.sourcemapFile" is only supported for single-file builds'));
    if (!outputOptions.amd.autoId && outputOptions.amd.id)
        log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.amd.id', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_AMD_ID */ .n3, 'this option is only properly supported for single-file builds. Use "output.amd.autoId" and "output.amd.basePath" instead'));
}
...
function getAbsoluteEntryModulePaths(includedModules, preserveModules) {
    ...
    for (const module of includedModules) {
        if ((module.info.isEntry || preserveModules) && (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isAbsolute */ .oP)(module.id)) {
...
function addModuleToManualChunk(alias, module, manualChunkAliasByEntry) {
    ...
    if (typeof existingAlias === 'string' && existingAlias !== alias) {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logCannotAssignModuleToChunk */ .f2)(module.id, alias, existingAlias));
    }
...
function isFileNameOutsideOutputDirectory(fileName) {
    ...
    const normalized = (0,node_path__WEBPACK_IMPORTED_MODULE_1__.join)(fileName).replaceAll('\\', '/');
    return (normalized === '..' ||
        normalized.startsWith('../') ||
        normalized === '.' ||
        (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isAbsolute */ .oP)(normalized));
}
function validateOutputBundleFileNames(bundle) {
    for (const [bundleKey, entry] of Object.entries(bundle)) {
        if (isFileNameOutsideOutputDirectory(bundleKey)) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFileNameOutsideOutputDirectory */ .zz)(bundleKey));
        }
        if (entry.type !== 'placeholder') {
            const { fileName } = entry;
            if (fileName !== bundleKey && isFileNameOutsideOutputDirectory(fileName)) {
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFileNameOutsideOutputDirectory */ .zz)(fileName));
            }
        }
    }
}
...
function resolveIdViaPlugins(source, importer, pluginDriver, moduleLoaderResolveId, skip, customOptions, isEntry, attributes, importerAttributes) {
    ...
    if (skip) {
        ...
        replaceContext = (pluginContext, plugin) => ({
            ...pluginContext,
            resolve: (source, importer, { attributes, custom, isEntry, skipSelf, importerAttributes } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) => {
                skipSelf ??= true;
                if (skipSelf &&
                ...
                return moduleLoaderResolveId(source, importer, custom, isEntry, attributes || _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0, importerAttributes, skipSelf ? [...skip, { importer, plugin, source }] : skip);
            }
        });
    }
...
async function resolveId(source, importer, preserveSymlinks, pluginDriver, moduleLoaderResolveId, skip, customOptions, isEntry, attributes, importerAttributes, fs) {
    ...
    if (importer !== undefined && !(0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isAbsolute */ .oP)(source) && source[0] !== '.')
        return null;
    // `resolve` processes paths from right to left, prepending them until an
    // absolute path is created. Absolute importees therefore shortcircuit the
    // resolve call and require no special handing on our part.
    // See https://nodejs.org/api/path.html#path_path_resolve_paths
    return addJsExtensionIfNecessary(importer ? (0,node_path__WEBPACK_IMPORTED_MODULE_1__.resolve)((0,node_path__WEBPACK_IMPORTED_MODULE_1__.dirname)(importer), source) : (0,node_path__WEBPACK_IMPORTED_MODULE_1__.resolve)(source), preserveSymlinks, fs);
}
...
async function findFile(file, preserveSymlinks, fs) {
    try {
        ...
        if ((preserveSymlinks && stats.isSymbolicLink()) || stats.isFile()) {
            ...
            const files = await fs.readdir((0,node_path__WEBPACK_IMPORTED_MODULE_1__.dirname)(file));
...
const getOnLog = (config, logLevel, printLog = defaultPrintLog) => {
    ...
    if (onLog) {
        const minimalPriority = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logLevelPriority */ .fl[logLevel];
        return (level, log) => onLog(level, addLogToString(log), (level, handledLog) => {
            if (level === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_ERROR */ .kt) {
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)(normalizeLog(handledLog));
            }
            if (_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logLevelPriority */ .fl[level] >= minimalPriority) {
...
const getDefaultOnLog = (printLog, onwarn) => onwarn
    ? (level, log) => {
        if (level === _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$) {
            onwarn(addLogToString(log), warning => printLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, normalizeLog(warning)));
        }
        else {
            printLog(level, log);
        }
...
const defaultPrintLog = (level, { message }) => {
    switch (level) {
        case _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$: {
            return console.warn(message);
        }
        case _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_DEBUG */ .Nu: {
...
function warnUnknownOptions(passedOptions, validOptions, optionType, log, ignoredKeys = /$./) {
    ...
    if (unknownOptions.length > 0) {
        log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logUnknownOption */ .GM)(optionType, unknownOptions, [...validOptionSet].sort()));
    }
}
const treeshakePresets = {
    recommended: {
        ...
        manualPureFunctions: _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .Ml,
...
const objectifyOptionWithPresets = (presets, optionName, urlSnippet, additionalValues) => (value) => {
    if (typeof value === 'string') {
        ...
        (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)(optionName, urlSnippet, `valid values are ${additionalValues}${(0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .printQuotedStringList */ .br)(Object.keys(presets))}. You can also supply an object for more fine-grained control`, value));
    }
...
const getOptionWithPreset = (value, presets, optionName, urlSnippet, additionalValues) => {
    ...
    if (presetName) {
        ...
        if (preset) {
            ...
            (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)(`${optionName}.preset`, urlSnippet, `valid values are ${(0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .printQuotedStringList */ .br)(Object.keys(presets))}`, presetName));
        }
    }
...
function uncacheablePluginError(pluginName) {
    if (pluginName.startsWith(ANONYMOUS_PLUGIN_PREFIX) ||
        ...
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logAnonymousPluginCache */ .Hr)());
    }
    return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logDuplicatePluginName */ .Kj)(pluginName));
}
...
async function transform(source, module, pluginDriver, options) {
        ...
        if (typeof result === 'string') {
            ...
            if (result.code == null) {
                if (result.map || result.ast) {
                    options.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logNoTransformMapOrAstWithoutCode */ .qI)(plugin.name));
                }
                return previousCode;
            }
            if (result.attributes) {
                (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .warnDeprecation */ .nL)('Returning attributes from the "transform" hook is forbidden.', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_TRANSFORM */ .hC, false, options);
            }
            ({ code, map, ast } = result);
        }
        else {
    ...
    const getLogHandler = (handler) => (log, pos) => {
        ...
        if (pos)
            (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .augmentCodeLocation */ .n)(log, pos, currentSource, id);
        log.id = id;
        log.hook = 'transform';
        handler(log);
    };
    ...
    try {
        code = await pluginDriver.hookReduceArg0('transform', [
            ...
            return {
                ...
                error(error_, pos) {
                    ...
                    if (pos)
                        (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .augmentCodeLocation */ .n)(error_, pos, currentSource, id);
                    error_.id = id;
                ...
                setAssetSource() {
                    return this.error((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidSetAssetSourceCall */ .bn)());
                },
        ...
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logPluginError */ .If)(error_, pluginName, { hook: 'transform', id }));
    }
...
class ModuleLoader {
    ...
    async preloadModule(resolvedId) {
        const module = await this.fetchModule(this.getResolvedIdWithDefaults(resolvedId, _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0), undefined, false, resolvedId.resolveDependencies ? RESOLVE_DEPENDENCIES : true);
        return module.info;
    }
    ...
    async addModuleSource(id, importer, module) {
        ...
        try {
            source = await this.graph.fileOperationQueue.run(async () => {
                ...
                if (content !== null) {
                    if (typeof content === 'object' && content.attributes) {
                        (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .warnDeprecation */ .nL)('Returning attributes from the "load" hook is forbidden.', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_LOAD */ .$2, false, this.options);
                    }
                    return content;
                }
            ...
            if (importer)
                message += ` (imported by ${(0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .relativeId */ .iW)(importer)})`;
        ...
        const sourceDescription = typeof source === 'string'
            ...
            : source != null && typeof source === 'object' && typeof source.code === 'string'
                ? source
                : (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logBadLoader */ .P2)(id));
    ...
    async fetchDynamicDependencies(module, resolveDynamicImportPromises) {
        const dependencies = await Promise.all(resolveDynamicImportPromises.map(resolveDynamicImportPromise => resolveDynamicImportPromise.then(async ([{ argument, node }, resolvedId]) => {
            ...
            if (node.phase === 'source' && !resolvedId.external) {
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logNonExternalSourcePhaseImport */ .qK)(typeof argument === 'string' ? argument : (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .relativeId */ .iW)(resolvedId.id), module.id));
            }
            return (node.resolution = await this.fetchResolvedDependency((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .relativeId */ .iW)(resolvedId.id), module.id, resolvedId));
        })));
        for (const dependency of dependencies) {
            if (dependency) {
    ...
    async fetchModule({ attributes, id, meta, moduleSideEffects, syntheticNamedExports }, importer, isEntry, isPreload) {
        ...
        if (existingModule instanceof Module) {
            if (importer && doAttributesDiffer(attributes, existingModule.info.attributes)) {
                this.options.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInconsistentImportAttributes */ .WX)(existingModule.info.attributes, attributes, id, importer));
            }
            await this.handleExistingModule(existingModule, isEntry, isPreload);
            return existingModule;
        }
        if (existingModule instanceof ExternalModule) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logExternalModulesCannotBeTransformedToModules */ .iw)(existingModule.id));
        }
    ...
    fetchResolvedDependency(source, importer, resolvedId) {
        if (resolvedId.external) {
            ...
            if (!externalModule) {
                externalModule = new ExternalModule(this.options, id, moduleSideEffects, meta, external !== 'absolute' && (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isAbsolute */ .oP)(id), attributes);
                this.modulesById.set(id, externalModule);
            }
            else if (!(externalModule instanceof ExternalModule)) {
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInternalIdCannotBeExternal */ .ec)(source, importer));
            }
            else if (doAttributesDiffer(externalModule.info.attributes, attributes)) {
                this.options.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInconsistentImportAttributes */ .WX)(externalModule.info.attributes, attributes, source, importer));
            }
    ...
    async fetchStaticDependencies(module, resolveStaticDependencyPromises) {
        for (const dependency of await Promise.all(resolveStaticDependencyPromises.map(resolveStaticDependencyPromise => resolveStaticDependencyPromise.then(([source, resolvedId]) => {
            if (module.sourcePhaseSources.has(source) && !resolvedId.external) {
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logNonExternalSourcePhaseImport */ .qK)(source, module.id));
            }
        ...
        if (resolveIdResult) {
            if (typeof resolveIdResult === 'object') {
                ...
                return {
                    ...
                    external: external &&
                        (external === 'relative' ||
                            !(0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isAbsolute */ .oP)(resolveIdResult.id) ||
                            (external === true &&
    ...
    getResolveStaticDependencyPromises(module) {
        return Array.from(module.sourcesWithAttributes, async ([source, attributes]) => [
            ...
            (module.resolvedIds[source] =
                module.resolvedIds[source] ||
                    this.handleInvalidResolvedId(await this.resolveId(source, module.id, _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0, false, attributes, module.info.attributes), source, module.id, attributes))
        ]);
    }
    ...
    handleInvalidResolvedId(resolvedId, source, importer, attributes) {
        if (resolvedId === null) {
            if ((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isRelative */ .Go)(source)) {
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logUnresolvedImport */ .pZ)(source, importer));
            }
            this.options.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logUnresolvedImportTreatedAsExternal */ .b0)(source, importer));
            return {
                attributes,
                external: true,
                id: source,
            ...
            this.options.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logExternalSyntheticExports */ .m0)(source, importer));
        }
        return resolvedId;
    }
    async loadEntryModule(unresolvedId, isEntry, importer, implicitlyLoadedBefore, isLoadForManualChunks = false, importerAttributes) {
        const resolveIdResult = await resolveId(unresolvedId, importer, this.options.preserveSymlinks, this.pluginDriver, this.resolveId, null, _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0, true, _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0, importerAttributes, this.options.fs);
        if (resolveIdResult == null) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)(implicitlyLoadedBefore === null
                ? (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logUnresolvedEntry */ .ki)(unresolvedId)
                : (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logUnresolvedImplicitDependant */ .sf)(unresolvedId, implicitlyLoadedBefore));
        }
        ...
        if (resolveIdResult === false || isExternalModules) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)(implicitlyLoadedBefore === null
                ? isExternalModules && isLoadForManualChunks
                    ? (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logExternalModulesCannotBeIncludedInManualChunks */ .qH)(unresolvedId)
                    : (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logEntryCannotBeExternal */ .oO)(unresolvedId)
                : (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logImplicitDependantCannotBeExternal */ .OQ)(unresolvedId, implicitlyLoadedBefore));
        }
        return this.fetchModule(this.getResolvedIdWithDefaults(typeof resolveIdResult === 'object'
            ? resolveIdResult
            : { id: resolveIdResult }, _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0), undefined, isEntry, false);
    }
        ...
        if (resolution == null) {
            ...
            if (existingResolution) {
                if (doAttributesDiffer(existingResolution.attributes, attributes)) {
                    this.options.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInconsistentImportAttributes */ .WX)(existingResolution.attributes, attributes, specifier, importer));
                }
                return existingResolution;
            }
            return (module.resolvedIds[specifier] = this.handleInvalidResolvedId(await this.resolveId(specifier, module.id, _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0, false, attributes, module.info.attributes), specifier, module.id, attributes));
        }
...
function normalizeRelativeExternalId(source, importer) {
    return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isRelative */ .Go)(source)
        ? importer
...
function isNotAbsoluteExternal(id, source, makeAbsoluteExternalsRelative) {
    return (makeAbsoluteExternalsRelative === true ||
        (makeAbsoluteExternalsRelative === 'ifRelativeSource' && (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isRelative */ .Go)(source)) ||
        !(0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isAbsolute */ .oP)(id));
}
...
function generateAssetFileName(name, names, source, originalFileName, originalFileNames, sourceHash, outputOptions, bundle, inputOptions) {
    ...
    return makeUnique(renderNamePattern(typeof outputOptions.assetFileNames === 'function'
        ? outputOptions.assetFileNames({
            ...
            get name() {
                (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .warnDeprecation */ .nL)('Accessing the "name" property of emitted assets when generating the file name is deprecated. Use the "names" property instead.', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_GENERATEBUNDLE */ .QF, false, inputOptions);
                return name;
            },
            names,
            // Additionally, this should be non-enumerable in the next major
            get originalFileName() {
                (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .warnDeprecation */ .nL)('Accessing the "originalFileName" property of emitted assets when generating the file name is deprecated. Use the "originalFileNames" property instead.', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_GENERATEBUNDLE */ .QF, false, inputOptions);
...
function reserveFileNameInBundle(fileName, { bundle }, log) {
    if (bundle[lowercaseBundleKeys].has(fileName.toLowerCase())) {
        log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFileNameConflict */ .g2)(fileName));
    }
    else {
...
function hasValidName(emittedFile) {
    ...
    return !validatedName || (typeof validatedName === 'string' && !(0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isPathFragment */ .A0)(validatedName));
}
function getValidSource(source, emittedFile, fileReferenceId) {
    if (!(typeof source === 'string' || source instanceof Uint8Array)) {
        const assetName = emittedFile.fileName || emittedFile.name || fileReferenceId;
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)(`Could not set source for ${typeof assetName === 'string' ? `asset "${assetName}"` : 'unnamed asset'}, asset source needs to be a string, Uint8Array or Buffer.`));
    }
    return source;
}
function getAssetFileName(file, referenceId) {
    if (typeof file.fileName !== 'string') {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logAssetNotFinalisedForFileName */ .N2)(file.name || referenceId));
    }
...
function getChunkFileName(file, facadeChunkByModule) {
    ...
    return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logChunkNotGeneratedForFileName */ .iv)(file.fileName || file.name));
}
class FileEmitter {
    constructor(graph, options, baseFileEmitter) {
        ...
        this.emitFile = (emittedFile) => {
            if (!hasValidType(emittedFile)) {
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)(`Emitted files must be of type "asset", "chunk" or "prebuilt-chunk", received "${emittedFile && emittedFile.type}".`));
            }
            if (emittedFile.type === 'prebuilt-chunk') {
                return this.emitPrebuiltChunk(emittedFile);
            }
            if (!hasValidName(emittedFile)) {
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)(`The "fileName" or "name" properties of emitted chunks and assets must be strings that are neither absolute nor relative paths, received "${emittedFile.fileName || emittedFile.name}".`));
            }
        ...
        this.finaliseAssets = () => {
            for (const [referenceId, emittedFile] of this.filesByReferenceId) {
                if (emittedFile.type === 'asset' && typeof emittedFile.fileName !== 'string')
                    return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logNoAssetSourceSet */ .H9)(emittedFile.name || referenceId));
            }
        };
        this.getFileName = (fileReferenceId) => {
            const emittedFile = this.filesByReferenceId.get(fileReferenceId);
            if (!emittedFile)
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFileReferenceIdNotFoundForFilename */ .C0)(fileReferenceId));
            if (emittedFile.type === 'chunk') {
        ...
        this.setAssetSource = (referenceId, requestedSource) => {
            ...
            if (!consumedFile)
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logAssetReferenceIdNotFoundForSetSource */ .c_)(referenceId));
            if (consumedFile.type !== 'asset') {
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)(`Asset sources can only be set for emitted assets but "${referenceId}" is an emitted chunk.`));
            }
            if (consumedFile.source !== undefined) {
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logAssetSourceAlreadySet */ ._z)(consumedFile.name || referenceId));
            }
    ...
    emitChunk(emittedChunk) {
        if (this.graph.phase > BuildPhase.LOAD_AND_PARSE) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidRollupPhaseForChunkEmission */ .s6)());
        }
        if (typeof emittedChunk.id !== 'string') {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)(`Emitted chunks need to have a valid string id, received "${emittedChunk.id}"`));
        }
        const consumedChunk = {
    ...
    emitPrebuiltChunk(emitPrebuiltChunk) {
        if (typeof emitPrebuiltChunk.code !== 'string') {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)(`Emitted prebuilt chunks need to have a valid string code, received "${emitPrebuiltChunk.code}".`));
        }
        if (typeof emitPrebuiltChunk.fileName !== 'string' ||
            (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isPathFragment */ .A0)(emitPrebuiltChunk.fileName)) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logFailedValidation */ .Tk)(`The "fileName" property of emitted prebuilt chunks must be strings that are neither absolute nor relative paths, received "${emitPrebuiltChunk.fileName}".`));
        }
    ...
    finalizeAdditionalAsset(consumedFile, source, { bundle, fileNamesBySourceHash, getHash, outputOptions }) {
        ...
        if (existingAsset?.type === 'asset') {
            ...
            bundle[fileName] = {
                ...
                get name() {
                    // Additionally, this should be non-enumerable in the next major
                    (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .warnDeprecation */ .nL)('Accessing the "name" property of emitted assets in the bundle is deprecated. Use the "names" property instead.', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_GENERATEBUNDLE */ .QF, false, options);
                    return name;
                },
                names: name ? [name] : [],
                needsCodeReference,
                get originalFileName() {
                    // Additionally, this should be non-enumerable in the next major
                    (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .warnDeprecation */ .nL)('Accessing the "originalFileName" property of emitted assets in the bundle is deprecated. Use the "originalFileNames" property instead.', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_GENERATEBUNDLE */ .QF, false, options);
                    return originalFileName;
                },
...
function getLogHandler(level, code, logger, pluginName, logLevel) {
    if (_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logLevelPriority */ .fl[level] < _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logLevelPriority */ .fl[logLevel]) {
        return doNothing;
    }
    return (log, pos) => {
        if (pos != null) {
            logger(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidLogPosition */ .tq)(pluginName));
        }
        log = normalizeLog(log);
...
function getPluginContext(plugin, pluginCache, graph, options, fileEmitter, existingPluginNames) {
    ...
    return {
        ...
        cache: cacheInstance,
        debug: getLogHandler(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_DEBUG */ .Nu, 'PLUGIN_LOG', onLog, plugin.name, logLevel),
        emitFile: fileEmitter.emitFile.bind(fileEmitter),
        error(error_) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logPluginError */ .If)(normalizeLog(error_), plugin.name));
        },
        fs: options.fs,
        ...
        info: getLogHandler(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_INFO */ .w0, 'PLUGIN_LOG', onLog, plugin.name, logLevel),
        load(resolvedId) {
        ...
        parse: _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .parseAst */ .u_,
        resolve(source, importer, { attributes, custom, isEntry, skipSelf, importerAttributes } = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .BLANK */ .Z4) {
            skipSelf ??= true;
            return graph.moduleLoader.resolveId(source, importer, custom, isEntry, attributes || _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJECT */ .t0, importerAttributes, skipSelf ? [{ importer, plugin, source }] : null);
        },
        setAssetSource: fileEmitter.setAssetSource,
        warn: getLogHandler(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, 'PLUGIN_WARNING', onLog, plugin.name, logLevel)
    };
}
...
function getMatcherString(glob, cwd) {
    if (glob.startsWith('**') || (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isAbsolute */ .oP)(glob)) {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .normalize */ .S8)(glob);
    }
    const resolved = (0,node_path__WEBPACK_IMPORTED_MODULE_1__.resolve)(cwd, glob);
    return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .normalize */ .S8)(resolved);
}
function patternToIdFilter(pattern) {
    if (pattern instanceof RegExp) {
        return (id) => {
            const normalizedId = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .normalize */ .S8)(id);
...
class PluginDriver {
        ...
        if (basePluginDriver) {
            for (const plugin of userPlugins) {
                for (const hook of inputHooks) {
                    if (hook in plugin) {
                        options.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInputHookInOutputPlugin */ .Xz)(plugin.name, hook));
                    }
                }
            }
        }
    ...
    runHook(hookName, parameters, plugin, replaceContext) {
        ...
        return Promise.resolve()
            ...
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logPluginError */ .If)(error_, plugin.name, { hook: hookName }));
        });
    }
    /**
...
function validateFunctionPluginHandler(handler, hookName, plugin) {
    if (typeof handler !== 'function') {
        (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidFunctionPluginHook */ .s5)(hookName, plugin.name));
    }
}
function validateAddonPluginHandler(handler, hookName, plugin) {
    if (typeof handler !== 'string' && typeof handler !== 'function') {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidAddonPluginHook */ .TM)(hookName, plugin.name));
    }
}
function noReturn() { }
...
class Graph {
        ...
        for (const module of this.implicitEntryModules) {
            for (const dependent of module.implicitlyLoadedAfter) {
                if (!(dependent.info.isEntry || dependent.isIncluded())) {
                    (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logImplicitDependantIsNotIncluded */ .Me)(dependent));
                }
            }
        }
    }
    sortAndBindModules() {
        ...
        for (const cyclePath of cyclePaths) {
            this.options.onLog(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logCircularDependency */ .x8)(cyclePath));
        }
        ...
        for (const module of this.modules) {
            for (const importDescription of module.importDescriptions.values()) {
                if (importDescription.name !== '*' && importDescription.phase !== 'source') {
                    ...
                    if (!variable) {
                        module.log(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logMissingExport */ .Lj)(importDescription.name, module.id, importDescription.module.id, !!options?.missingButExportExists), importDescription.start);
                    }
                }
            }
        }
...
function getLogger(plugins, onLog, watchMode, logLevel) {
    ...
    const minimalPriority = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logLevelPriority */ .fl[logLevel];
    const logger = (level, log, skipped = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_SET */ .XR) => {
        (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .augmentLogMessage */ .DX)(log);
        const logPriority = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logLevelPriority */ .fl[level];
        ...
        for (const plugin of plugins) {
            ...
            if (handler.call({
                debug: getLogHandler(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_DEBUG */ .Nu),
                error: (log) => (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)(normalizeLog(log)),
                info: getLogHandler(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_INFO */ .w0),
                meta: { rollupVersion: rollupVersion$1, watchMode },
                warn: getLogHandler(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$)
            }, level, log) === false) {
                return;
            }
        }
...
const fs = /*#__PURE__*/_mergeNamespaces({
  __proto__: null
}, [/*#__PURE__*/ (node_fs_promises__WEBPACK_IMPORTED_MODULE_6___namespace_cache || (node_fs_promises__WEBPACK_IMPORTED_MODULE_6___namespace_cache = __webpack_require__.t(node_fs_promises__WEBPACK_IMPORTED_MODULE_6__, 2)))]);
...
async function normalizeInputOptions(config, watchMode) {
    ...
    const logLevel = config.logLevel || _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_INFO */ .w0;
...
const getJsx = (config) => {
    ...
    if (!configJsx)
        return false;
    const configWithPreset = getOptionWithPreset(configJsx, jsxPresets, 'jsx', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_JSX */ .m2, 'false, ');
    ...
    switch (mode) {
        ...
        case 'preserve': {
            if (importSource && !(factory || configWithPreset.fragment)) {
                (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('jsx', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_JSX */ .m2, 'when preserving JSX and specifying an importSource, you also need to specify a factory or fragment'));
            }
            return {
        ...
        default: {
            if (mode && mode !== 'classic') {
                (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('jsx.mode', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_JSX */ .m2, 'mode must be "automatic", "classic" or "preserve"', mode));
            }
            return {
                factory: factory || 'React.createElement',
...
const getTreeshake = (config) => {
    ...
    const configWithPreset = getOptionWithPreset(config.treeshake, treeshakePresets, 'treeshake', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_TREESHAKE */ .Jn, 'false, true, ');
    return {
        annotations: configWithPreset.annotations !== false,
        correctVarValueBeforeDeclaration: configWithPreset.correctVarValueBeforeDeclaration === true,
        manualPureFunctions: configWithPreset.manualPureFunctions ?? _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .Ml,
...
const getHasModuleSideEffects = (moduleSideEffectsOption) => {
    ...
    if (moduleSideEffectsOption) {
        (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('treeshake.moduleSideEffects', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_TREESHAKE_MODULESIDEEFFECTS */ .JT, 'please use one of false, "no-external", a function or an array'));
    }
    return () => true;
};
...
const getFile = (config, preserveModules, inputOptions) => {
    ...
    if (typeof file === 'string') {
        if (preserveModules) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.file', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_DIR */ .CN, 'you must set "output.dir" instead of "output.file" when using the "output.preserveModules" option'));
        }
        if (!Array.isArray(inputOptions.input))
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.file', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_DIR */ .CN, 'you must set "output.dir" instead of "output.file" when providing named inputs'));
    }
    return file;
};
const getFormat = (config) => {
    ...
    switch (configFormat) {
        ...
        default: {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.format', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_FORMAT */ .Q$, `Valid values are "amd", "cjs", "system", "es", "iife" or "umd"`, configFormat));
        }
    }
};
const getInlineDynamicImports = (config, inputOptions) => {
    ...
    if (inlineDynamicImports && (Array.isArray(input) ? input : Object.keys(input)).length > 1) {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.inlineDynamicImports', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_INLINEDYNAMICIMPORTS */ .Hk, 'multiple inputs are not supported when "output.inlineDynamicImports" is true'));
    }
...
const getPreserveModules = (config, inlineDynamicImports, inputOptions) => {
    ...
    if (preserveModules) {
        if (inlineDynamicImports) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.inlineDynamicImports', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_INLINEDYNAMICIMPORTS */ .Hk, `this option is not supported for "output.preserveModules"`));
        }
        if (inputOptions.preserveEntrySignatures === false) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('preserveEntrySignatures', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_PRESERVEENTRYSIGNATURES */ .cC, 'setting this option to false is not supported for "output.preserveModules"'));
        }
    }
...
const getAmd = (config) => {
    ...
    if ((mergedOption.autoId || mergedOption.basePath) && mergedOption.id) {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.amd.id', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_AMD_ID */ .n3, 'this option cannot be used together with "output.amd.autoId"/"output.amd.basePath"'));
    }
    if (mergedOption.basePath && !mergedOption.autoId) {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.amd.basePath', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_AMD_BASEPATH */ .CP, 'this option only works with "output.amd.autoId"'));
    }
...
const getDir = (config, file) => {
    ...
    if (typeof dir === 'string' && typeof file === 'string') {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.dir', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_DIR */ .CN, 'you must set either "output.file" for a single-file build or "output.dir" when generating multiple chunks'));
    }
    return dir;
};
...
function getExports(config, unsetOptions) {
    ...
    if (configExports == null) {
        ...
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidExportOptionValue */ .Yd)(configExports));
    }
    return configExports || 'auto';
}
const getExternalImportAttributes = (config, inputOptions) => {
    if (config.externalImportAssertions != undefined) {
        (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .warnDeprecation */ .nL)(`The "output.externalImportAssertions" option is deprecated. Use the "output.externalImportAttributes" option instead.`, _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_EXTERNALIMPORTATTRIBUTES */ .iA, true, inputOptions);
    }
    return config.externalImportAttributes ?? config.externalImportAssertions ?? true;
};
const getGeneratedCode = (config) => {
    const configWithPreset = getOptionWithPreset(config.generatedCode, generatedCodePresets, 'output.generatedCode', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_GENERATEDCODE */ .T$, '');
    return {
...
const validateInterop = (interop) => {
    if (!ALLOWED_INTEROP_TYPES.has(interop)) {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.interop', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_INTEROP */ .sF, `use one of ${Array.from(ALLOWED_INTEROP_TYPES, value => JSON.stringify(value)).join(', ')}`, interop));
    }
    return interop;
};
const getManualChunks = (config, inlineDynamicImports, preserveModules) => {
    ...
    if (configManualChunks) {
        if (inlineDynamicImports) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.manualChunks', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_MANUALCHUNKS */ .Jz, 'this option is not supported for "output.inlineDynamicImports"'));
        }
        if (preserveModules) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.manualChunks', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_MANUALCHUNKS */ .Jz, 'this option is not supported for "output.preserveModules"'));
        }
    }
...
const getSourcemapBaseUrl = (config) => {
    ...
    if (sourcemapBaseUrl) {
        if ((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .isValidUrl */ .AY)(sourcemapBaseUrl)) {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .addTrailingSlashIfMissed */ .h$)(sourcemapBaseUrl);
        }
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('output.sourcemapBaseUrl', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_SOURCEMAPBASEURL */ .Gx, `must be a valid URL, received ${JSON.stringify(sourcemapBaseUrl)}`));
    }
};
...
async function rollupInternal(rawInputOptions, watcher) {
    ...
    await catchUnfinishedHookActions(graph.pluginDriver, async () => {
        try {
            ...
            try {
                ...
                const compoundError = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .getRollupError */ .f9)({
                    ...error_,
    ...
    const result = {
        ...
        async generate(rawOutputOptions) {
            if (result.closed)
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logAlreadyClosed */ .V5)());
...
async function getProcessedInputOptions(inputOptions, watchMode) {
    ...
    const logLevel = inputOptions.logLevel || _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_INFO */ .w0;
    ...
    for (const plugin of plugins) {
        ...
        const processedOptions = await handler.call({
            debug: getLogHandler(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_DEBUG */ .Nu, 'PLUGIN_LOG', logger, name, logLevel),
            error: (error_) => (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logPluginError */ .If)(normalizeLog(error_), name, { hook: 'onLog' })),
            info: getLogHandler(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_INFO */ .w0, 'PLUGIN_LOG', logger, name, logLevel),
            meta: { rollupVersion, watchMode },
            warn: getLogHandler(_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .LOGLEVEL_WARN */ .S$, 'PLUGIN_WARNING', logger, name, logLevel)
        }, inputOptions);
        if (processedOptions) {
    ...
    return catchUnfinishedHookActions(outputPluginDriver, async () => {
        ...
        if (isWrite) {
            ...
            if (!outputOptions.dir && !outputOptions.file) {
                return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logMissingFileOrDirOption */ .I8)());
            }
...
function getOutputOptions(inputOptions, unsetInputOptions, rawOutputOptions, outputPluginDriver) {
    return normalizeOutputOptions(outputPluginDriver.hookReduceArg0Sync('outputOptions', [rawOutputOptions], (outputOptions, result) => result || outputOptions, pluginContext => {
        const emitError = () => pluginContext.error((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logCannotEmitFromOptionsHook */ .ip)());
        return {
            ...pluginContext,
            emitFile: emitError,
...
async function writeOutputFile(outputFile, outputOptions, { fs: { mkdir, writeFile } }) {
    ...
    await mkdir((0,node_path__WEBPACK_IMPORTED_MODULE_1__.dirname)(fileName), { recursive: true });
...
const { bold, cyan, dim, red} = pc.createColors(node_process__WEBPACK_IMPORTED_MODULE_4__.env.FORCE_COLOR !== '0' && !node_process__WEBPACK_IMPORTED_MODULE_4__.env.NO_COLOR);
...
function handleError(error, recover = false) {
    ...
    if (error.loc) {
        outputLines.push(`${(0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .relativeId */ .iW)((error.loc.file || error.id))} (${error.loc.line}:${error.loc.column})`);
    }
    else if (error.id) {
        outputLines.push((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .relativeId */ .iW)(error.id));
    }
    if (error.frame) {
...
function mergeInputOptions(config, overrides, plugins, log, onLog) {
    ...
    const inputOptions = {
        ...
        jsx: getObjectOption(config, overrides, 'jsx', objectifyOptionWithPresets(jsxPresets, 'jsx', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_JSX */ .m2, 'false, ')),
        ...
        treeshake: getObjectOption(config, overrides, 'treeshake', objectifyOptionWithPresets(treeshakePresets, 'treeshake', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_TREESHAKE */ .Jn, 'false, true, ')),
...
async function mergeOutputOptions(config, overrides, log) {
    ...
    const outputOptions = {
        ...
        generatedCode: getObjectOption(config, overrides, 'generatedCode', objectifyOptionWithPresets(generatedCodePresets, 'output.generatedCode', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_OUTPUT_GENERATEDCODE */ .T$, '')),
...
async function loadFsEvents() {
    try {
        ({ default: fsEvents } = await __webpack_require__.e(/* import() */ 178).then(__webpack_require__.t.bind(__webpack_require__, 4178, 19)));
    }
    catch (error) {
        ...
        if (item.input && item.output) {
            ...
            for (const index in input) {
                ...
                if (outputWithInputAsSubPath) {
                    (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('watch', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_WATCH */ .G5, `the input "${inputPath}" is a subpath of the output "${outputWithInputAsSubPath.dir}"`));
                }
            }
        }
    }
...
async function watchInternal(configs, emitter) {
    ...
    if (watchOptionsList.length === 0) {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .logInvalidOption */ .lY)('watch', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__/* .URL_WATCH */ .G5, 'there must be at least one config where "watch" is not set to "false"'));
    }
    checkWatchConfig(watchOptionsList);
    await loadFsEvents();
    const { Watcher } = await __webpack_require__.e(/* import() */ 569).then(__webpack_require__.bind(__webpack_require__, 7569));
