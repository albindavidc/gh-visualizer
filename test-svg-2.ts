...
fs.writeFileSync('test-hidelang.svg', svg);
const svg2 = generateSvg('albindavidc', 1000, weeks, 'github', undefined, 'inter', false, false);
fs.writeFileSync('test-showlang.svg', svg2);
